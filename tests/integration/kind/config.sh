...
export SKUPPER_CRD_BASE="${VMS_SKUPPER_CRD_BASE:-https://github.com/fgiorgetti/skupper/raw/refs/heads/multi-van-without-crds/config/crd/bases}"
export SKUPPER_CONTROLLER_IMAGE="${VMS_SKUPPER_CONTROLLER_IMAGE:-quay.io/fgiorgetti/controller:multi-van-slim}"
export SKUPPER_ADAPTOR_IMAGE="${VMS_SKUPPER_ADAPTOR_IMAGE:-quay.io/fgiorgetti/kube-adaptor:multi-van-slim}"
